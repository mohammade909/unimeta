...
class UserInvestment {
  ...
  //     const commissionSettings = await SystemSettings.getValueByKey(
  //       "direct_income"
  //     );

  //     console.log(
  //       "Commission settings retrieved:",
  //       JSON.stringify(commissionSettings, null, 2)
  //     );

  //     if (!commissionSettings || !commissionSettings.enabled) {
  //       console.log("❌ Commission distribution is disabled");
  //       return {
  //         success: true,
  ...
  //     console.log(`Max levels configured: ${max_level}`);
  //     console.log(
  //       `Percentages configured:`,
  //       JSON.stringify(percentages, null, 2)
  //     );

  //     if (!max_level || max_level <= 0) {
  //       console.log("❌ Invalid max_level in commission settings");
  //       return { success: true, message: "Invalid commission settings" };
  //     }

  //     // Get user's referrer chain
  //     console.log(
  //       `Fetching referrer chain for user ${userId} up to ${max_level} levels...`
  //     );
  ...
  //       console.log(
  //         `  Level ${index + 1}: ${referrer.username} (ID: ${referrer.id})`
  //       );
  //     });
  ...
  //     console.log("\n=== Processing Commission Distribution ===");
  ...
  //       console.log(
  //         `\nProcessing Level ${level} - User: ${referrer.username} (ID: ${referrer.id})`
  //       );

  //       // Get percentage for this level (default percentages if not specified)
  //       let percentage = 0;
  //       if (percentages && percentages[level]) {
  //         percentage = percentages[level];
  //         console.log(`Using configured percentage: ${percentage}%`);
  //       } else {
  //         // Default percentages
  //         switch (level) {
  //           case 1:
  ...
  //             percentage = 0.5; // 0.5%
  //         }
  //         console.log(`Using default percentage: ${percentage}%`);
  //       }

  //       if (percentage > 0) {
  //         const commissionAmount = (investmentAmount * percentage) / 100;
  //         console.log(
  //           `Calculated commission: $${commissionAmount} (${percentage}% of $${investmentAmount})`
  //         );
  ...
  //           if (result.success) {
  //             console.log(
  //               `✅ Commission successfully processed for level ${level}`
  //             );
  ...
  //             });
  //           } else {
  //             console.log(`❌ Failed to process commission for level ${level}`);
  //           }
  //         } catch (error) {
  //           console.error(
  //             `❌ Error processing commission for level ${level}:`,
  //             error
  //           );
  //           throw error;
  //         }
  //       } else {
  //         console.log(`⚠️ Skipping level ${level} - zero percentage`);
  //       }
  //     }

  //     console.log("\n=== Commission Distribution Summary ===");
  //     console.log(`Total levels processed: ${processedLevels.length}`);
  //     console.log(
  //       `Total commission distributed: $${totalCommissionDistributed}`
  //     );
  //     console.log(
  //       `Processed levels:`,
  //       JSON.stringify(processedLevels, null, 2)
  //     );
  ...
  //       summary: {
  //         total_distributed: totalCommissionDistributed,
