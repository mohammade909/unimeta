...
const NotFound = () => {
  ...
  return (
    ...
    //   {/* Floating shapes */}
    //   <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-r from-pink-500 to-violet-500 rounded-full blur-xl opacity-20 animate-bounce"></div>
    //   <div className="absolute bottom-20 right-20 w-40 h-40 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full blur-xl opacity-20 animate-pulse"></div>

    //   <div
    //     className={`text-center z-10 px-8 transform transition-all duration-500 ${
    //       false? "scale-95 opacity-0" : "scale-100 opacity-100"
    //     }`}
    //   >
    //     {/* 404 Text with glow effect */}
    //     <div className="relative mb-8">
    //       <h1 className="text-9xl md:text-[12rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-violet-400 to-cyan-400 animate-pulse">
    //         404
    //       </h1>
    //       <div className="absolute inset-0 text-9xl md:text-[12rem] font-black text-violet-500 blur-lg opacity-30 animate-pulse">
    //         404
    //       </div>
    //     </div>
    ...
    //         <div className="absolute inset-0 w-20 h-20 bg-yellow-400 rounded-full blur-lg opacity-30 animate-ping"></div>
    //       </div>
    //     </div>
    ...
    //       <button className="group bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl font-semibold flex items-center gap-3 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-violet-500/25">
    ...
    <div className="relative h-screen flex justify-center items-center flex-col bg-black">
      <svg
        width={314}
        height={171}
        viewBox="0 0 314 171"
      ...
      >
        ...
        {/* Keep your original SVG content here */}
        {/* You can optionally change SVG colors to golden tones as well */}
      </svg>

      <div className="block text-center mt-5">
        <h5 className="md:text-xl text-lg leading-8 text-yellow-400 font-medium mb-1">
          <span className="text-green-300">Oops!</span> It seems like you've
          taken a wrong turn
        </h5>
